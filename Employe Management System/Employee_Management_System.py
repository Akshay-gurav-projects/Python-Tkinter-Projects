...
def data_insert():
    if (entry_1.get() == '' or entry_2.get() == "" or entry_3.get() == ""):
        ...
        my_cursor.execute("insert into employeemanagement(dept_no,dept_name,location) values(%s,%s,%s)",
...
labl1_5 = Label(root, text="PRESS SELECT ON RECORD BELOW TO UPDATE AND DELETE", bg='sky blue', font='Arial 15 bold',
                fg='black')
